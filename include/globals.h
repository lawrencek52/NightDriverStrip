...
#ifndef AUDIO_WEB_SOCKET_ENABLED
  #if ENABLE_WIFI && ENABLE_WEBSERVER && ENABLE_AUDIO
    #define AUDIO_WEB_SOCKET_ENABLED 1
  #else
    #define AUDIO_WEB_SOCKET_ENABLED 0
  #endif
#endif

#define WEB_SOCKETS_ANY_ENABLED (COLORDATA_WEB_SOCKET_ENABLED || EFFECTS_WEB_SOCKET_ENABLED || AUDIO_WEB_SOCKET_ENABLED)
