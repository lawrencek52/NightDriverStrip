...
void LoadEffectFactories()
{
    ...
    // These sections are shared by multiple projects
        ...
        RegisterAll(*g_ptrEffectFactories,
            ...
            Effect<GlobalColorStarEffect<QuietStar>>("Rainbow Twinkle Stars", RainbowColors_p, kStarEffectProbability, 1, LINEARBLEND, 2.0, 0.0, kStarEffectMusicFactor),
        ...
        RegisterAll(*g_ptrEffectFactories,
            ...
            Effect<GlobalColorStarEffect<QuietStar>>("Red Twinkle Stars", RedColors_p,   1.0, 1, LINEARBLEND, 2.0),
            Effect<GlobalColorStarEffect<QuietStar>>("Green Twinkle Stars", GreenColors_p, kStarEffectProbability, 1, LINEARBLEND, 2.0, 0.0, kStarEffectMusicFactor),
            Effect<GlobalColorStarEffect<QuietStar>>("Blue Twinkle Stars", BlueColors_p, kStarEffectProbability, 1, LINEARBLEND, 2.0, 0.0, kStarEffectMusicFactor),
            Effect<GlobalColorStarEffect<QuietStar>>("Rainbow Twinkle Stars", RainbowColors_p, kStarEffectProbability, 1, LINEARBLEND, 2.0, 0.0, kStarEffectMusicFactor),
            Effect<NightTwinkleEffect>(),
